      ...
      <div className="max-w-7xl mx-auto px-6 pt-32">
        ...
        to-tertiary bg-clip-text text-transparent"
            ...
            >
              ...
              Proficient in technologies such as JavaScript, TypeScript, MySQL,
              and PHP, with hands-on experience in Git collaboration and
              responsive UI design. Always eager to learn and innovate.
            </motion.p>
            <Link href="/projects">
              <motion.button
                initial={{ opacity: 0, y: 20 }}
                  ...
                  <div className="text-2xl font-bold text-content">
                    ...
                    <motion.span
                      className="block bg-gradient-to-r
                       from-tertiary to-secondary bg-clip-text text-transparent"
